...
#define KKDateFormatter08 [NSString stringWithFormat:@"yyyy%@MM%@",KILocalization(@"年"),KILocalization(@"月")]
#define KKDateFormatter09 [NSString stringWithFormat:@"MM%@dd%@",KILocalization(@"月"),KILocalization(@"日")]
...
/**
 ...
 @return 结果
 */
+ (nullable NSString *)getStringFromTimestamp:(nullable NSString*)aTimestamp
