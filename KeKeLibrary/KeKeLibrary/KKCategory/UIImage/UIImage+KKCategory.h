...
#define ImageWithFileName(FileName)  [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:FileName ofType:nil]]
#define ImageWithFilePath(FilePath)  [UIImage imageWithContentsOfFile:FilePath]
