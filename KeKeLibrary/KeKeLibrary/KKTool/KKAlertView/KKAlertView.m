...
#define NotificationName_ShowAlertView @"NotificationName_ShowAlertView"
#define NotificationName_HideAlertView @"NotificationName_HideAlertView"
            ...
            buttonTitlesArray:(NSArray *)aButtonTitlesArray
{
    ...
    if (self) {
        ...
        [self observeNotificaiton:NotificationName_ShowAlertView selector:@selector(Notification_ShowAlertView:)];
        [self observeNotificaiton:NotificationName_HideAlertView selector:@selector(Notification_HideAlertView:)];
        ...
        if ([NSString isStringEmpty:self.myTitleString]) {
            self.myTitleString = @"温馨提示";
        }
...
//    [window addSubview:self];
    ...
    [self postNotification:NotificationName_HideAlertView object:self.myShowingIdentifier];
...
- (void)setAllButton:(CGFloat)aYOffset forReload:(BOOL)aForReload{
    ...
    if ([self.buttonTitlesArray count]==0) {
        ...
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(0, Y, self.myBackgroundView.frame.size.width, 50)];
        ...
        UIButton *button01 = [[UIButton alloc] initWithFrame:CGRectMake(0, Y, self.myBackgroundView.frame.size.width/2.0-0.5, 50)];
        ...
        UIButton *button02 = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(button01.frame)+1, Y, self.myBackgroundView.frame.size.width/2.0-0.5, 50)];
        ...
        for (NSInteger i=0; i<[self.buttonTitlesArray count]; i++) {
            UIButton *button01 = [[UIButton alloc] initWithFrame:CGRectMake(0, Y, self.myBackgroundView.frame.size.width, 50)];
            button01.titleLabel.font = ButtonTitleFont;
...
+ (void)showNextAlertView{
    ...
    if ([savedViews count]==0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NotificationName_ShowAlertView object:identifier];
    }
}
