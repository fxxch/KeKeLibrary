...
@property (nonatomic, copy) NSString *KKPageScrollView_PageIndex;
@property (nonatomic, copy) NSString *KKPageScrollView_Location;
@property (nonatomic, copy) NSString *KKPageScrollView_Real;
@end
