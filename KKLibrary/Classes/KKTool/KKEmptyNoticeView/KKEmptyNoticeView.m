...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        UIColor *textColor = [UIColor kk_colorWithHexString:@"#8899A9"];
        ...
        if (alignment==KKEmptyNoticeViewAlignment_Top) {
            ...
            if ([NSString kk_isStringEmpty:aButtonTitle]) {
        ...
        if ([NSString kk_isStringNotEmpty:aText]) {
        ...
        if ([NSString kk_isStringNotEmpty:aButtonTitle]) {
            ...
            [button kk_setCornerRadius:5];
            [button kk_setBorderColor:[UIColor blueColor] width:1.0];
