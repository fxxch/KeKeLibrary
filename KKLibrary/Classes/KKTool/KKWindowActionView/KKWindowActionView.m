                     ...
                     delegate:(id<KKWindowActionViewDelegate>)aDelegate
{
    ...
    if (self) {
        ...
        [self.contentScrollView kk_setCornerRadius:10 type:KKCornerRadiusType_LeftTop | KKCornerRadiusType_RightTop];
        ...
        for (NSInteger i=0; i<[self.itemArray count]; i++) {
            ...
            [button setImage:item.image
                       title:item.title
                  titleColor:item.titleColor?item.titleColor:[UIColor blackColor]
             backgroundColor:[UIColor kk_colorWithHexString:@"#EEEEEE"]
            ...
            button.bottomLineView.backgroundColor = [UIColor kk_colorWithHexString:@"#EEEEEE"];
            ...
            if (i==[self.itemArray count]-2) {
                ...
                sepView.backgroundColor = [UIColor kk_colorWithHexString:@"#EEEEEE"];
                [self.contentScrollView addSubview:sepView];
                offsetY = offsetY + sepView.kk_height;
            }
        }
    }
    return self;
