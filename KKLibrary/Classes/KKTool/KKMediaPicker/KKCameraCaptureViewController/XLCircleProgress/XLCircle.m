...
//    backLayer.strokeColor  = [UIColor colorWithRed:50.0/255.0f green:50.0/255.0f blue:50.0/255.0f alpha:1].CGColor;
    backLayer.strokeColor  = [UIColor colorWithRed:0.86f green:0.85f blue:0.84f alpha:1.00f].CGColor;
    ...
    //指定path的渲染颜色
    _progressLayer.strokeColor  = [[UIColor colorWithRed:0.07f green:0.59f blue:0.86f alpha:1.00f] CGColor];
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[[UIColor colorWithRed:0.07f green:0.59f blue:0.86f alpha:1.00f] CGColor],(id)[[UIColor colorWithRed:0.07f green:0.59f blue:0.86f alpha:1.00f] CGColor], nil]];
    ...
    _endPoint.backgroundColor = [UIColor colorWithRed:0.07f green:0.59f blue:0.86f alpha:1.00f];
